...
import { useEffect, useRef, type ToggleEvent } from "react";
  ...
  return (
    <div className="sm:hidden">
      ...
      <div
        ...
        className="mobile-nav-popover fixed inset-0 z-50 m-0 h-dvh max-h-none w-screen max-w-none overflow-hidden border-0 bg-transparent p-0 sm:hidden"
      >
        <button
          type="button"
          tabIndex={-1}
